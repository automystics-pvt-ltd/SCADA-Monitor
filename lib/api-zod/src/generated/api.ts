...
export const ListPlatformTelemetryParametersResponse = zod.object({
  ...
  "category": zod.string(),
  "evidenceAvailable": zod.boolean(),
  "rawValue": zod.string().nullable(),
  "reportedValue": zod.string().nullable(),
  ...
  "provenance": zod.enum(['live', 'retained', 'recovered', 'replay', 'snapshot', 'configuration']),
